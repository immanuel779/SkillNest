...
export default function NotificationBell() {
  ...
  useEffect(() => {
    ...
    const unsub = subscribeNotifications(user.uid, (list) => {
      ...
      const filtered = list.filter((n) => {
        ...
        if (
          (n.type === 'new_job' ||
            n.type === 'company_update' ||
            n.type === 'platform_announcement') &&
  ...
  const handleClick = (n) => {
    // Mark read (best-effort) and open the detail modal
  ...
  return (
    <>
      <div className="relative" ref={ref}>
        ...
        {open && (
          <div className="absolute right-0 mt-2 w-80 sm:w-96 max-w-[calc(100vw-1.5rem)] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-50">
            ...
            <button
              ...
              className="block w-full text-center text-xs font-semibold text-brand-700 py-3 border-t border-gray-100 hover:bg-gray-50"
            >
      ...
      {/* Detail modal — full text of the notification */}
